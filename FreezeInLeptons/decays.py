...
Decay_e__minus__ = Decay(name = 'Decay_e__minus__',
                         ...
                         partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((Me**2*yHEeR**2 + mHE**2*yHEeR**2 - ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(Me)**3)',
...
Decay_P__tilde__he = Decay(name = 'Decay_P__tilde__he',
                           ...
                           partial_widths = {(P.P__tilde__s0,P.e__minus__):'((Me**2*yHEeR**2 + mHE**2*yHEeR**2 - ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.mu__minus__):'((mHE**2*yHEmuR**2 + MMU**2*yHEmuR**2 - ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.ta__minus__):'((mHE**2*yHEtaR**2 - ms0**2*yHEtaR**2 + MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(mHE)**3)'})

Decay_mu__minus__ = Decay(name = 'Decay_mu__minus__',
                          particle = P.mu__minus__,
                          partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((mHE**2*yHEmuR**2 + MMU**2*yHEmuR**2 - ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(MMU)**3)',
...
Decay_P__tilde__s0 = Decay(name = 'Decay_P__tilde__s0',
                           ...
                           partial_widths = {(P.e__minus__,P.P__tilde__HE):'((-(Me**2*yHEeR**2) - mHE**2*yHEeR**2 + ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.e__plus__):'((-(Me**2*yHEeR**2) - mHE**2*yHEeR**2 + ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.mu__plus__):'((-(mHE**2*yHEmuR**2) - MMU**2*yHEmuR**2 + ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.ta__plus__):'((-(mHE**2*yHEtaR**2) + ms0**2*yHEtaR**2 - MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.mu__minus__,P.P__tilde__HE):'((-(mHE**2*yHEmuR**2) - MMU**2*yHEmuR**2 + ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.ta__minus__,P.P__tilde__HE):'((-(mHE**2*yHEtaR**2) + ms0**2*yHEtaR**2 - MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(16.*cmath.pi*abs(ms0)**3)'})
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((mHE**2*yHEtaR**2 - ms0**2*yHEtaR**2 + MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.P__tilde__he,P.P__tilde__HE):'(((8*ee**2*mHE**2*sw**2)/cw**2 + (4*ee**2*MZ**2*sw**2)/cw**2)*cmath.sqrt(-4*mHE**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
