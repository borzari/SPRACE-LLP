...
V_118 = Vertex(name = 'V_118',
               particles = [ P.mu__minus__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_83})

V_119 = Vertex(name = 'V_119',
               particles = [ P.ta__minus__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
...
V_123 = Vertex(name = 'V_123',
               particles = [ P.P__tilde__HE, P.e__plus__, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_82})
