...
Decay_P__tilde__he = Decay(name = 'Decay_P__tilde__he',
                           ...
                           partial_widths = {(P.P__tilde__s0,P.e__plus__):'((Me**2*yHEeR**2 + mHE**2*yHEeR**2 - ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.mu__plus__):'((mHE**2*yHEmuR**2 + MMU**2*yHEmuR**2 - ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(32.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.ta__plus__):'((mHE**2*yHEtaR**2 - ms0**2*yHEtaR**2 + MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(mHE)**3)'})
...
Decay_P__tilde__s0 = Decay(name = 'Decay_P__tilde__s0',
                           ...
                           partial_widths = {(P.e__minus__,P.P__tilde__he):'((-(Me**2*yHEeR**2) - mHE**2*yHEeR**2 + ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.e__plus__,P.P__tilde__HE):'((-(Me**2*yHEeR**2) - mHE**2*yHEeR**2 + ms0**2*yHEeR**2)*cmath.sqrt(Me**4 - 2*Me**2*mHE**2 + mHE**4 - 2*Me**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.mu__minus__):'((-(mHE**2*yHEmuR**2) - MMU**2*yHEmuR**2 + ms0**2*yHEmuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*MMU**2 + MMU**4 - 2*mHE**2*ms0**2 - 2*MMU**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.ta__minus__):'((-(mHE**2*yHEtaR**2) + ms0**2*yHEtaR**2 - MTA**2*yHEtaR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MTA**2 - 2*ms0**2*MTA**2 + MTA**4))/(16.*cmath.pi*abs(ms0)**3)',
