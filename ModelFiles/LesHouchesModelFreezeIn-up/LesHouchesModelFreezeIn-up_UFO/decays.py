...
Decay_c = Decay(name = 'Decay_c',
                particle = P.c,
                partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((3*MC**2*yHEcR**2 + 3*mHE**2*yHEcR**2 - 3*ms0**2*yHEcR**2)*cmath.sqrt(MC**4 - 2*MC**2*mHE**2 + mHE**4 - 2*MC**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(96.*cmath.pi*abs(MC)**3)',
...
Decay_P__tilde__he = Decay(name = 'Decay_P__tilde__he',
                           ...
                           partial_widths = {(P.P__tilde__s0,P.c):'((3*MC**2*yHEcR**2 + 3*mHE**2*yHEcR**2 - 3*ms0**2*yHEcR**2)*cmath.sqrt(MC**4 - 2*MC**2*mHE**2 + mHE**4 - 2*MC**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(96.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.t):'((3*mHE**2*yHEtR**2 - 3*ms0**2*yHEtR**2 + 3*MT**2*yHEtR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MT**2 - 2*ms0**2*MT**2 + MT**4))/(96.*cmath.pi*abs(mHE)**3)',
                                             (P.P__tilde__s0,P.u):'((3*mHE**2*yHEuR**2 - 3*ms0**2*yHEuR**2 + 3*MU**2*yHEuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MU**2 - 2*ms0**2*MU**2 + MU**4))/(96.*cmath.pi*abs(mHE)**3)'})
...
Decay_P__tilde__s0 = Decay(name = 'Decay_P__tilde__s0',
                           ...
                           partial_widths = {(P.c,P.P__tilde__HE):'((-3*MC**2*yHEcR**2 - 3*mHE**2*yHEcR**2 + 3*ms0**2*yHEcR**2)*cmath.sqrt(MC**4 - 2*MC**2*mHE**2 + mHE**4 - 2*MC**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.c__tilde__):'((-3*MC**2*yHEcR**2 - 3*mHE**2*yHEcR**2 + 3*ms0**2*yHEcR**2)*cmath.sqrt(MC**4 - 2*MC**2*mHE**2 + mHE**4 - 2*MC**2*ms0**2 - 2*mHE**2*ms0**2 + ms0**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.t__tilde__):'((-3*mHE**2*yHEtR**2 + 3*ms0**2*yHEtR**2 - 3*MT**2*yHEtR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MT**2 - 2*ms0**2*MT**2 + MT**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.P__tilde__he,P.u__tilde__):'((-3*mHE**2*yHEuR**2 + 3*ms0**2*yHEuR**2 - 3*MU**2*yHEuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MU**2 - 2*ms0**2*MU**2 + MU**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.t,P.P__tilde__HE):'((-3*mHE**2*yHEtR**2 + 3*ms0**2*yHEtR**2 - 3*MT**2*yHEtR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MT**2 - 2*ms0**2*MT**2 + MT**4))/(16.*cmath.pi*abs(ms0)**3)',
                                             (P.u,P.P__tilde__HE):'((-3*mHE**2*yHEuR**2 + 3*ms0**2*yHEuR**2 - 3*MU**2*yHEuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MU**2 - 2*ms0**2*MU**2 + MU**4))/(16.*cmath.pi*abs(ms0)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((3*mHE**2*yHEtR**2 - 3*ms0**2*yHEtR**2 + 3*MT**2*yHEtR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MT**2 - 2*ms0**2*MT**2 + MT**4))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_u = Decay(name = 'Decay_u',
                particle = P.u,
                partial_widths = {(P.P__tilde__s0,P.P__tilde__he):'((3*mHE**2*yHEuR**2 - 3*ms0**2*yHEuR**2 + 3*MU**2*yHEuR**2)*cmath.sqrt(mHE**4 - 2*mHE**2*ms0**2 + ms0**4 - 2*mHE**2*MU**2 - 2*ms0**2*MU**2 + MU**4))/(96.*cmath.pi*abs(MU)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.P__tilde__he,P.P__tilde__HE):'(((32*ee**2*mHE**2*sw**2)/(3.*cw**2) + (16*ee**2*MZ**2*sw**2)/(3.*cw**2))*cmath.sqrt(-4*mHE**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
