...
V_118 = Vertex(name = 'V_118',
               particles = [ P.P__tilde__HE, P.u, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_83})

V_119 = Vertex(name = 'V_119',
               particles = [ P.P__tilde__HE, P.c, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_81})

V_120 = Vertex(name = 'V_120',
               particles = [ P.P__tilde__HE, P.t, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_82})

V_121 = Vertex(name = 'V_121',
               particles = [ P.u__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_83})

V_122 = Vertex(name = 'V_122',
               particles = [ P.c__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_81})

V_123 = Vertex(name = 'V_123',
               particles = [ P.t__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_82})
...
V_152 = Vertex(name = 'V_152',
               particles = [ P.P__tilde__HE, P.P__tilde__he, P.g ],
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_11})
