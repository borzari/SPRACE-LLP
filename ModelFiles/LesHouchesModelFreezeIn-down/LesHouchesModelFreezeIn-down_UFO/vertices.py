...
V_118 = Vertex(name = 'V_118',
               particles = [ P.P__tilde__HE, P.d, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_82})

V_119 = Vertex(name = 'V_119',
               particles = [ P.P__tilde__HE, P.s, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_83})

V_120 = Vertex(name = 'V_120',
               particles = [ P.P__tilde__HE, P.b, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_81})

V_121 = Vertex(name = 'V_121',
               particles = [ P.d__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_82})

V_122 = Vertex(name = 'V_122',
               particles = [ P.s__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_83})

V_123 = Vertex(name = 'V_123',
               particles = [ P.b__tilde__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_81})
